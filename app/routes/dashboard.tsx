      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="stats-card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-cyan-100 text-sm font-medium">Total Documentos</p>
        ...
        <div className="card">
          <div className="p-6 flex items-center justify-between">
            <div>
              <p className="text-slate-500 text-sm font-medium">Propuestas</p>
              <p className="text-3xl font-bold text-slate-800 mt-1">
                {documents.filter(d => d.tipo?.toLowerCase() === 'propuesta').length}
              </p>
            </div>
        ...
        <div className="card">
          <div className="p-6 flex items-center justify-between">
            <div>
              <p className="text-slate-500 text-sm font-medium">Presupuestos</p>
              <p className="text-3xl font-bold text-slate-800 mt-1">
                {documents.filter(d => d.tipo?.toLowerCase() === 'presupuesto').length}
              </p>
            </div>
